...
def agregarPersona(request):
    if request.method=="POST":
        ...
        form= PersonaForm()
        return render(request, "AppCoder/agregarPersona.html", {"formulario": form})
...
def editarPersona(request, id):
    ...
    if request.method=="POST":
        ...
        if formulario.is_valid():
            ...
            persona.save()
            personas= Persona.objects.all()
            return render(request, "AppCoder/personas.html", {"personas": personas, "mensaje": "Persona editada correctamente"})


    else:
        
        form= PersonaForm(initial={"dni": persona.dni, "nombre": persona.nombre, "apellido": persona.apellido, "email": persona.email, "fechaNacimiento": persona.fechaNacimiento, "tieneObraSocial": persona.tieneObraSocial})
        return render(request, "AppCoder/editarPersona.html", {"formulario": form, "persona": persona})
...
def eliminarPersona(request, id):
    ...
    persona.delete()
    personas= Persona.objects.all()
    return render(request, "AppCoder/personas.html", {"personas": personas, "mensaje": "Persona eliminada correctamente"})